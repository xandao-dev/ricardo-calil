<template>
	<section id="atuacao" class="px-8 py-12 lg:px-12">
		...
		<div class="grid gap-8 row-gap-5 sm:row-gap-8 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
			<div v-for="expertise in areas" :key="expertise.id" class="flex flex-col">
				...
				<a
					v-if="expertise.target"
					:href="expertise.target"
					class="font-medium underline underline-primary flex flex-1 items-end"
