	...
	>
		<div class="relative flex flex-col justify-center items-center text-center lg:text-left lg:items-start">
			<h1 class="text-4xl font-bold text-white sm:text-6xl md:px-28 lg:text-primary-900 lg:pr-12 lg:pl-0">
				...
				<span class="text-primary-400 lg:text-primary" v-text="info.title"></span> a mais de 30 anos
			</h1>
			<p
				class="text-gray-200 pt-6 pb-12 sm:px-12 md:text-lg md:px-28 lg:text-primary-900 lg:pr-12 lg:pl-0"
				v-text="info.description"
			></p>
			<NuxtLink draggable="false" :to="{ path: $route.path, hash: 'contato' }">
				<button
					class="flex items-center text-white select-none bg-primary hover:bg-primary-700 active:bg-primary-800 font-semibold rounded px-6 py-3 mx-auto whitespace-nowrap focus:outline-none sm:px-8 sm:py-4 sm:text-xl md:px-12 lg:mr-12"
				>
					<svg
