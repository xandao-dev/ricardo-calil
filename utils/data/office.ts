const office = {
	...
	awards: 'Durante a caminhada de Dr. Ricardo Calil na advocacia, recebeu a honrosa missão de ser o presidente a OAB subseção de Itaberaí, no período de 2016 a 2018. Uma conquista que lhe trouxe muitas experiências.',
};
